...
// POST /api/scenarios-web/:id/execute
scenarioRoutes.post('/:id/execute', async (req: Request, res: Response) => {
  ...
  // Web scenario execution not yet implemented - return stub result
  res.json({
    code: 200,
    message: 'ok',
    data: {
      ...
      duration_ms: 0,
      steps: [],
      error_message: 'Web scenario execution not yet implemented',
      executed_by: executedBy,
    }
  });
});

// GET /api/scenarios-web/:id/logs
