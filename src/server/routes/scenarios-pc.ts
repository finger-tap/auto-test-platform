...
// POST /api/scenarios-pc/:id/execute
scenarioRoutes.post('/:id/execute', async (req: Request, res: Response) => {
  ...
  // PC scenario execution not yet implemented - return stub result
  res.json({
    code: 200,
    message: 'ok',
    data: {
      ...
      duration_ms: 0,
      steps: [],
      error_message: 'PC scenario execution not yet implemented',
      executed_by: executedBy,
    }
  });
});

// GET /api/scenarios-pc/:id/logs
