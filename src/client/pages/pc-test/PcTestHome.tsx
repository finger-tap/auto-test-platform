...
export default function PcTestHome() {
  ...
  useEffect(() => {
    Promise.all([
      ...
      apiFetch<{ total: number }>('/case-sets-pc?page=1&pageSize=1'),
          ...
          <table className="dashboard-table">
            ...
            <tbody>
              {reports.map(r => {
                ...
                return (
                  <tr key={r.id} onClick={() => navigate(`/pc-test/batch-report/${r.id}`)}>
      ...
      <div className="dash-bottom">
        ...
        <div className="dashboard-panel">
          ...
          <div className="shortcut-grid">
            <button className="shortcut-btn" onClick={() => navigate('/pc-test/case/new')}>
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="var(--accent)" strokeWidth="2"><path d="M12 5v14M5 12h14"/></svg>
              新建用例
            </button>
            <button className="shortcut-btn" onClick={() => navigate('/pc-test/case-set/new')}>
            ...
            <button className="shortcut-btn" onClick={() => navigate('/pc-test/environment')}>
            ...
            <button className="shortcut-btn" onClick={() => navigate('/pc-test/system-config')}>
