...
export default function ExecutionResultPanel({ log, nodes, edges, title, onClose }: Props) {
  ...
  const results: Record<string, NodeExecutionResult> = log.node_results ? JSON.parse(log.node_results) : {};
    ...
    <div className="scenario-exec-result">
      ...
      <div className="scenario-exec-nodes">
        ...
        {displayNodes.map((node) => {
          ...
          return (
            <div key={node.id} className={`scenario-exec-node scenario-exec-${result.status}`}>
              <div
                className="scenario-exec-node-header"
              ...
              >
                ...
                <span className="scenario-exec-node-toggle">{isExpanded ? '收起' : '展开'}</span>
              </div>
                ...
                <div className="scenario-exec-node-detail">
                  ...
                  <div className="scenario-exec-field">
                    ...
                    {(() => {
                      ...
                      if (!hasExtract && !hasAssertions) {
                        return <div style={{ fontSize: 12, color: '#ccc', textAlign: 'center', padding: '8px 0' }}>暂无数据</div>;
                      }
                      ...
                      return (
                        <>
                          {/* Extract values */}
                          {/*{hasExtract && (*/}
                          {/*  <div className="scenario-exec-extract-values" style={{ marginBottom: hasAssertions ? 8 : 0 }}>*/}
                          ...
                          {/*        <span className="scenario-exec-extract-val">{value}</span>*/}
                          {/*      </div>*/}
                          {/*    ))}*/}
                          {/*  </div>*/}
                          {/*)}*/}
